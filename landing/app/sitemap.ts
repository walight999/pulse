...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE}/demo`,                              lastModified: today, changeFrequency: "weekly",  priority: 0.95 },
    ...
    { url: `${BASE}/alternatives`,                      lastModified: today, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE}/roadmap`,                           lastModified: today, changeFrequency: "weekly",  priority: 0.8 },
    { url: `${BASE}/compare/claude-code-cost-tracker`,  lastModified: today, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/compare/cursor-cost-tracker`,       lastModified: today, changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/#features`,                         lastModified: today, changeFrequency: "weekly",  priority: 0.75 },
