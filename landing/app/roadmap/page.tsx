...
const cols: Col[] = [
  {
    title: "Now",
    subtitle: "Shipped — local app v1.6",
    badge: "Available",
    ...
    items: [
      ...
      "Anthropic Admin API sync (org token usage)",
      "OpenAI /v1/usage parser (GPT-5 + GPT-4o + o-series pricing)",
      "Cursor IDE local state-DB parser (read-only)",
      "GitHub Copilot org usage sync (admin PAT)",
      "Browser extension Manifest V3 (ChatGPT / Claude.ai / Gemini / Perplexity)",
      "Ask pulse assistant (Anthropic Messages API + local SQL tools)",
      "Plan ROI vs equivalent API value",
      "Cache TTL pricing (5m + 1h split)",
      "Local activity tracker (foreground time, opt-in)",
      "Cost-per-active-hour per subscription",
      "Cancellation savings counter",
      "CSV export + sample CSV at /samples/",
  ...
  },
  {
    ...
    items: [
      ...
      "ChatGPT Plus export parser (flat-plan message counts)",
      "Mistral parser",
